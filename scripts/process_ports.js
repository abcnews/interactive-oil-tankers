...
// BELOW HERE JUST A TEST TO DRAW LINES
...
// const AUSTRALIA_CENTRE = [134.0, -25.7];
...
// if ([countryIdx, portIdx, coordsIdx].includes(-1)) {
//   console.error('Could not find expected columns. Headers found:', headers);
//   process.exit(1);
// }
...
//   // LineString from port → centre of Australia
//   features.push({
//     type: 'Feature',
//     geometry: {
//       type: 'LineString',
//       coordinates: [[longitude, latitude], AUSTRALIA_CENTRE],
//     },
//     properties: { ...props },
//   });
// }
...
// writeFileSync(outputPath, JSON.stringify(geojson, null, 2), 'utf8');
// console.log(`✓ Wrote ${features.length / 2} points + ${features.length / 2} lines → ${outputPath}`);
